                                        ...
                                        <div id="form-searach" method="POST">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-12 col-lg-2 col-xl-2">
                                                    <button id="" class="btn btn-primary btn-block d-md-inline"><a class="text-light" href="<?= site_url('it/tambah_dokumen') ?>"><i class='mdi mdi-file-document'></i> Tambah</a></button>
                                                </div>
                                            </div>
                                        </div>
