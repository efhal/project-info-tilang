                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="form-searach" method="POST">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-12 col-lg-3 col-xl-2">
                                                    <select id="logistik" class="form-control" id="exampleSelect">
                                                        <option value="">Logistik</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-12 col-lg-3 col-xl-2">
                                                    <select id="instansi" class="form-control" id="exampleSelect">
                                                        <option value="">Instansi</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-12 col-lg-3 col-xl-2">
                                                    <select id="layanan" class="form-control" id="exampleSelect">
