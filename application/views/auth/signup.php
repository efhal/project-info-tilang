                        ...
                        <div class="card-body">
                            ...
                            <form id="form">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control border-left-0  border-top-0 border-right-0" name="email" type="text" id="email" required="" placeholder="Masukan email">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="password">Password</label>
                                    <div class="input-group input-group-merge">
                                        <input type="password" name="password" id="password" class="form-control border-left-0  border-top-0 border-right-0" placeholder="Masukan password">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" name="re_password" id="re_password" class="form-control border-left-0  border-top-0 border-right-0" placeholder="Ulangi password">
                                        <div class="input-group-append" data-password="false">
                                            <div class="my-auto pl-1">
                                                <span class="password-eye"></span>
                                            </div>
                ...
                $.post({
                    ...
                    success: function(res) {
                        ...
                        if (res_obj.hasOwnProperty('status')) {
                            ...
                            if (res_obj.status == 'form_success') {
